...
#
#  $ bin/test -s hiremi.api -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src hiremi.api.testing.HIREMI_API_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/hiremi/api/tests/robot/test_example.robot
#
